    ...
    <div className="pt-4 lg:pt-10">
      <div className="px-[20px] lg:px-[280px]">
        ...
        <p className="text-center pt-6 text-[#36485C] lg:text-[18px] lg:leading-7">
          Tenha uma visão panorâmica com nosso painel personalizável. Fique no
          controle de tudo! Reestruture seu processo de trabalho com nosso
          recurso inovador. Aumente a produtividade e a eficiência!
        </p>
        ...
        <div className="flex w-full pt-8 justify-center gap-x-6 ">
          ...
          <button className="w-1/2 text-[#4328EB] flex items-center justify-center gap-x-2 lg:w-fit">
            Ver Preços
            <span>
              <Image src={BlurArrow} alt="Saiba mais" />
            </span>
          </button>
        </div>
      </div>
