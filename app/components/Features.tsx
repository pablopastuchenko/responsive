    ...
    <div className="flex flex-col gap-y-[56px] py-[56px] lg:py-[120px] lg:gap-y-[80px] ">
      <div className="flex flex-col gap-x-6 sm:flex-row-reverse">
        ...
        <div className="sm:w-1/2 lg:py-[56px] lg:pr-[56px]">
          ...
          <p className="py-[24px] text-[#36485C] lg:text-[18px]">
            Fique no controle e renove seu processo de trabalho com nosso recurso inovador. Tenha uma visão panorâmica com nosso painel personalizável.
          </p>

          <ul className="flex flex-col gap-y-3 lg:text-[18px]">
            <li className="flex items-center gap-x-2 text-[#36485C]">
              <span>
                <Image src={Check} alt="Marca de Verificação" />
              </span>
          ...
          <p className="flex items-center gap-x-2 pt-[24px] font-medium text-[#0085FF] lg:text-[18px]">
            Saiba Mais{" "}
            <span>
              <Image src={bluebutton} alt="Saiba mais" />
            </span>
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-col gap-x-6 sm:flex-row">
        ...
        <div className="sm:w-1/2 lg:py-[56px] lg:pl-[56px]">
          ...
          <p className="flex items-center gap-x-2 pt-[24px] font-medium text-[#00A424] lg:text-[18px]">
            Saiba Mais{" "}
            <span>
              <Image src={greenButton} alt="Saiba mais" />
            </span>
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-col gap-x-6 sm:flex-row-reverse">
        ...
        <div className="sm:w-1/2 lg:py-[56px] lg:pr-[56px]">
          ...
          <h1 className="pt-[12px] text-2xl font-medium text-[#172026] lg:text-[42px] lg:leading-[58px]">
            Monitore novos assinantes do seu site
          </h1>
          <Image
            src={Feature3}
            alt="Imagem da Feature 3"
          ...
          <p className="flex items-center gap-x-2 pt-[24px] font-medium text-[#EB2891] lg:text-[18px]">
            Saiba Mais{" "}
            <span>
              <Image src={pinkButton} alt="Saiba mais" />
            </span>
          </p>
        </div>
      </div>
